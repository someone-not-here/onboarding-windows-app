...
I wrote several samples of code that demonstrates the following smells:
...
Refactoring improved code readability by reducing complexity, getting rid of duplicate code, and clarifying intent by deobfuscating some variables/functions.

### How can avoiding code smells make future debugging easier?
Avoiding code smells helps keep the codebase clean, readable, and predictable. There would be fewer bugs hidden within long functions and duplicate code, testing would be easier to do thanks to smaller functions, and developers would spend less time deciphering what the code does and more actually fixing bugs.

## Examples

*Code location: code/code_smells.cs*
